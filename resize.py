...
def resize(file, min_crack_length):
    ...
    for i in range(y_sample_start, height):
        ...
        if r < 30 and g < 30 and b < 30 and not start_crack_triguered:
            y_start_crack = i
    ...
    if need_to_flip:
        ...
        for j in range(0, height):
            ...
            if r < 30 and g < 30 and b < 30 and start_sample_triguered_2 and not start_crack_triguered_2:
                y_start_crack_2 = j
            ...
            if r < 30 and g < 30 and b < 30 and start_sample_triguered_2 and start_crack_triguered_2 and end_crack_triguered_2 and not end_sample_triguered_2:
                y_sample_end_2 = j
                end_sample_triguered = True
