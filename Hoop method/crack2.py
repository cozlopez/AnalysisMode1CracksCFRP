#import numpy as np
def filterr(name, crack_threshold2, display, threshold = 100, crack_open = 10, crack_threshold = 167, n_x = 33, n_y = 6 ): #n_x is the x neibourhood, n_y is the y neighborhoud
